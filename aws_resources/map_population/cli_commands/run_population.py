...
def main(
    ...
    side_by_bearing_offset_deg: float = 51.0,
) -> int:
    ...
    logger.info("Using side_by_bearing offset: %.2f deg", float(side_by_bearing_offset_deg))
    ...
    try:
        ...
        for building_data in all_buildings_data:
            ...
            populate_database(
                conn,
                building_data,
                coordinate_angle_offset_deg=coordinate_angle_offset_deg,
                side_by_bearing_offset_deg=side_by_bearing_offset_deg,
            )
