...
def test_live_navigation_stationary(ws_api_url, rest_api_url, ws_endpoint_healthy, dummy_base64_image):
    ...
    try:
        ...
        estimated_x = estimated_pos.get("coordinates", {}).get("x", -1.0)
        estimated_y = estimated_pos.get("coordinates", {}).get("y", -1.0)
...
def test_live_navigation_moving_and_state_persistence(ws_api_url, rest_api_url, ws_endpoint_healthy, dummy_base64_image):
    ...
    try:
        ...
        estimated_x1 = est_pos1.get("coordinates", {}).get("x", 0.0)
        estimated_y1 = est_pos1.get("coordinates", {}).get("y", 0.0)
        ...
        estimated_x2 = est_pos2.get("coordinates", {}).get("x", 0.0)
        estimated_y2 = est_pos2.get("coordinates", {}).get("y", 0.0)
