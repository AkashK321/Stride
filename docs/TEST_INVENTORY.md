...
| UI-12 | Integration | FR-7 | React Native Testing Library, Jest | Yes | Yes | Tests useHeading hook subscription lifecycle, rolling average smoothing, trueHeading/magHeading fallback, and getAlignment across 0°/360° boundary | [link](../frontend/__tests__/Useheading.test.tsx) |